...
sealed interface RemoteHelper {
    ...
    companion object {
        fun get(device: Device) = when (device.product_data.model_id) {
            ...
            "ROM001" -> HueSmartButtonV1
            "RDM005" -> HueSmartButtonV2
            else -> throw RuntimeException("Unsupported remote controller: ≪${device.product_data.model_id}≫")
        }

        fun listSupportedModelIds() = listOf("RWL021", "RWL022", "ROM001", "RDM005")
    }
...
private data object HueSmartButtonV1 : RemoteHelper {
    override fun getButtonCode(button: String, pressType: String): Int {
        val base = 1000
        return when (pressType) {
            "initial_press" -> base
...
private data object HueSmartButtonV2 : RemoteHelper {
    override fun getButtonCode(button: String, pressType: String): Int {
        val base = 1000
        return when (pressType) {
            "initial_press" -> base
